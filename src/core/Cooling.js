...
window.TEUI.CoolingFields = {
  ...
  cooling_atmosphericPressure: {
    label: "Atmospheric Pressure",
    description: "Barometric pressure adjusted for elevation",
    type: "calculated",
    section: "mechanicalLoads",
    format: "number-2dp",
    unit: "kPa",
  ...
  ref_cooling_atmosphericPressure: {
    label: "Atmospheric Pressure (Reference)",
    description: "Reference model barometric pressure",
    type: "calculated",
    section: "mechanicalLoads",
    format: "number-2dp",
    unit: "kPa",
    dependencies: ["ref_l_22"],
    stage: 1,
  },

  cooling_partialPressure: {
    label: "Partial Vapor Pressure",
    description: "Water vapor partial pressure from temperature and RH",
    type: "calculated",
    section: "mechanicalLoads",
    format: "number-3dp",
    unit: "kPa",
    dependencies: ["l_20", "l_21", "cooling_atmosphericPressure"],
    stage: 1,
  },
  ref_cooling_partialPressure: {
    label: "Partial Vapor Pressure (Reference)",
    description: "Reference model vapor pressure",
    type: "calculated",
    section: "mechanicalLoads",
    format: "number-3dp",
    unit: "kPa",
    dependencies: ["ref_l_20", "ref_l_21", "ref_cooling_atmosphericPressure"],
    stage: 1,
  },

  cooling_humidityRatio: {
    label: "Humidity Ratio Difference",
    description: "Absolute humidity difference for latent load calculation",
    type: "calculated",
    section: "mechanicalLoads",
    format: "number-6dp",
    unit: "kg/kg",
  ...
  ref_cooling_humidityRatio: {
    label: "Humidity Ratio Difference (Reference)",
    description: "Reference model humidity ratio",
    type: "calculated",
    section: "mechanicalLoads",
    format: "number-6dp",
    unit: "kg/kg",
  ...
  cooling_h_124: {
    ...
    dependencies: ["l_20", "h_24", "m_19", "d_21", "d_105", "h_15", "g_118", "k_120"],
...
if (window.TEUI?.FieldManager?.registerFields) {
  ...
  console.log(
    "[CoolingFields] ✅ Registered 16 cooling calculation fields with FieldManager (8 Target + 8 Reference)"
  );
}
