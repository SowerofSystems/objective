    ...
    subheader_meta: {
      ...
      cells: {
        c: {
          ...
          classes: ["group-header", "section-subheader"],
        },
        d: { classes: ["section-subheader"] },
        e: { classes: ["section-subheader"] },
        f: { classes: ["section-subheader"] },
        g: { classes: ["section-subheader"] },
        h: { classes: ["section-subheader"] },
        i: { classes: ["section-subheader"] },
        j: { classes: ["section-subheader"] },
        k: { classes: ["section-subheader"] },
        l: { classes: ["section-subheader"] },
        m: { classes: ["section-subheader"] },
        n: { classes: ["section-subheader"] },
      },
    },
