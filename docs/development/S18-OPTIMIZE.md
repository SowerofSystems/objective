...
- [Overview](#overview)
- [1. D3.js Library Analysis](#1-d3js-library-analysis)
  - [Current External Dependencies](#current-external-dependencies-from-indexhtml)
  - [D3.js v7 Parallel Coordinates Capability](#d3js-v7-parallel-coordinates-capability)
  - [Licensing ✅](#licensing-)
- [2. Architecture Pattern](#2-architecture-pattern-following-s16s17)
  - [Section Module Structure](#section-module-structure-section18js)
  - [Dedicated Visualization Module](#dedicated-visualization-module-parallelcoordinatesjs)
- [3. HTML Structure ✅](#3-html-structure-already-set-up-)
- [4. Layout Specification](#4-layout-specification)
  - [Visual Layout (80/20 Split)](#visual-layout-8020-split)
  - [Control Panel (Top Row)](#control-panel-top-row)
- [5. Data Integration](#5-data-integration)
  - [StateManager Pattern (Mode-Aware)](#statemanager-pattern-mode-aware)
  - [Data Structure for Parallel Coordinates](#data-structure-for-parallel-coordinates)
  - [Two-Line Rendering (Target & Reference)](#two-line-rendering-target--reference)
- [6. Styling and Differentiation](#6-styling-and-differentiation)
- [7. Implementation Phases](#7-implementation-phases)
  - [Phase 1: Infrastructure Setup ✅](#phase-1-infrastructure-setup--completed)
  - [Phase 2: Data Schema ✅](#phase-2-data-schema--completed-november-23-2025)
  - [Phase 3: Core Visualization Module ✅](#phase-3-core-visualization-module--completed-november-24-2025)
  - [Phase 4: Integration & Testing ⚠️](#phase-4-integration--testing--in-progress-november-24-2025)
...
- [11. Dependencies Summary](#11-dependencies-summary)
  - [External Libraries ✅](#external-libraries-already-loaded-)
...
- [Successful Fix - Session 3 (November 24)](#successful-fix---session-3-november-24-2025)
  ...
  - [Current Status - SUCCESS ✅](#current-status---success-)
- [Afternoon Workplan - Graph Refinements](#afternoon-workplan---graph-refinements)
  - [Task 1: Remove Table Header Row](#task-1-remove-table-header-row)
  - [Task 2: Flip Efficiency Axes](#task-2-flip-efficiency-axes-invert-y-scale)
  - [Task 2b: WWR Scale Adjustment](#task-2b-wwr-scale-adjustment)
  - [Task 3: Move Legend to Controls Row](#task-3-move-legend-to-controls-row)
  - [Implementation Order](#implementation-order)
  - [Success Criteria](#success-criteria)
- [Implementation Status (November 24 - Post-Compact)](#implementation-status-november-24-2025---post-compact)
  - [✅ Completed Tasks](#-completed-tasks)
  - [⚠️ Known Issues](#-known-issues)
  - [📋 Afternoon Session #2 - Axis Scaling & Domain Refinements](#-afternoon-session-2---axis-scaling--domain-refinements)
  - [📋 Polish & Final Refinements](#-polish--final-refinements)
  - [🎯 Current Success State](#-current-success-state)
- [Next Steps (Planned Features)](#next-steps-planned-features)
  - [🎯 Priority: Financial Metrics Rows](#-priority-financial-metrics-rows)
- [✅ nGains% Formula - IMPLEMENTED](#-ngains-formula---implemented-november-24-2025-late-evening)
  - [What is nGains%?](#what-is-ngains)
  - [Implementation Logic](#implementation-logic)
  - [Cost Calculation](#cost-calculation-same-pattern-as-shw)
  - [Savings Logic](#savings-logic-reversed-pattern)
  - [Summary: Savings Pattern Classification](#summary-savings-pattern-classification)
  - [✅ Clarification: nGains% Savings Logic](#-clarification-ngains-savings-logic-nov-24-late-evening---resolved)
- [📝 TB% Formula - READY TO IMPLEMENT](#-tb-formula---ready-to-implement)
  - [What is TB%?](#what-is-tb)
  - [Implementation Logic](#implementation-logic-1)
  - [Cost Calculation](#cost-calculation-same-pattern-as-ngains)
  - [Savings Logic](#savings-logic-standard-pattern)
  - [Summary: Pattern Classification](#summary-pattern-classification-updated)
  - [🎯 Priority: Data Point Tooltips](#-priority-data-point-tooltips)
  - [🔮 Future Enhancements](#-future-enhancements)
- [🎮 Interactivity - Interactive Node Dragging](#-interactivity---interactive-node-dragging-future-feature)
  ...
  - [Benefits of This Feature](#benefits-of-this-feature)
- [📋 Developer Handoff Guide - Adding New Editable Axes](#-developer-handoff-guide---adding-new-editable-axes)
  - [Quick Reference: Axes to Implement](#quick-reference-axes-to-implement)
  - [Step-by-Step Implementation Process](#step-by-step-implementation-process)
    - [Step 1: Identify Field Details](#step-1-identify-field-details)
    - [Step 2: Add Configuration to EDITABLE_AXES](#step-2-add-configuration-to-editable_axes)
    - [Step 3: Field Mapping Reference](#step-3-field-mapping-reference)
      - [SHW% - Service Hot Water Efficiency ✅](#shw---service-hot-water-efficiency--implemented)
      ...
      - [HEAT% - Heating System Efficiency ✅](#heat---heating-system-efficiency---section-13--implemented)
      - [MVHR% - Mechanical Ventilation Heat Recovery ✅](#mvhr---mechanical-ventilation-heat-recovery---section-13--implemented)
    - [Step 4: Verify CSS Styling](#step-4-verify-css-styling)
    - [Step 5: Test Your Implementation](#step-5-test-your-implementation)
    - [Step 6: Common Pitfalls and Solutions](#step-6-common-pitfalls-and-solutions)
  - [Architecture Deep Dive](#architecture-deep-dive)
  - [Code Reference: Complete dragEnded() Implementation](#code-reference-complete-dragended-implementation)
  - [Verification Script](#verification-script)
  - [Summary: What You Need to Do](#summary-what-you-need-to-do)
- [Previous Attempts (Historical Record)](#previous-attempts-historical-record)
...
| 2025-11-24 | Interactive Axes | Implemented SHW%, DWHR%, nGains%, TB%, ACH50 with 8 patterns (A-H) |
| 2025-11-25 | HEAT% & MVHR% Complete | **All easily editable axes now implemented** (6/10 interactive axes) |
| 2025-11-25 | Polish | Added ACH50 unit label, adjusted MVHR% step to 0.5% intervals |

---

**Document Version**: 1.3
**Last Updated**: November 25, 2025 (NOVA Session - Interactive Axes Complete)
**Agent**: NOVA (Standing alongside COSMO, HELIOS, ORIONIS, STELLARIA, ANDROMEDA)
...
**Storage Pattern:** Multi-fuel conditional - uses different fields based on d_113 (heating system type)
- **Heatpump:** h_113 (COP) calculated from f_113 (HSPF) via formula: `h_113 = f_113 / 3.412`
- **Gas/Oil:** j_115 (AFUE) stores as decimal (0.90 for 90%)
...
'heating_efficiency': {
  ...
  min: 0,                            // 0% to allow visual space for AFUE range (50-100%)
...
**pcConfig.js:** Uses conditional multipliers based on fuel type
```javascript
{
  id: "heating_efficiency",
  // Target mode fields
...
To allow dragging in S18, we **invert** this formula to set HSPF from COP%:
```javascript
...
**🔥 HSPF Modal Subtitle (Heatpump >100% only):**

When dragging HEAT% above 100% (heatpump mode), modal shows COP and HSPF conversion:
```javascript
// ParallelCoordinates.js lines 1328-1338
let subtitle = null;
...
```javascript
// ParallelCoordinates.js lines 1497-1522
if (d.axisId === 'heating_efficiency' && clampedValue > 100) {
  ...
  // Convert to HSPF for f_113 storage
  const cop = clampedValue / 100;                      // 105% → 1.05
  const hspf = cop * 3.412;                            // 1.05 → 3.58
  storageValue = Math.round(hspf * 100) / 100;         // 3.58

  // Update to heatpump field (f_113)
  fieldToWrite = 'f_113';
...
**Why This Matters:**
- Gas/Oil AFUE physically limited to 100% maximum (thermodynamics)
- Dragging to 105% automatically switches d_113 to "Heatpump"
...
| Gas | "Gas" | j_115 (AFUE) | j_115 | Direct AFUE (decimal) |
| Oil | "Oil" | j_115 (AFUE) | j_115 | Direct AFUE (decimal) |

**Storage Format:**
- **Heatpump:** Display 400%, write HSPF 13.65 to f_113, Section 13 calculates h_113 = 4.0
- **Electric:** Display 100%, h_113 = 1 (calculated, not editable via drag)
- **Gas/Oil:** Display 90%, write AFUE 0.90 to j_115

**Interactive Behavior:**
- Heatpump: Snaps to 5% intervals (100, 105, 110, ..., 585, 586), shows HSPF subtitle
- Gas/Oil: Snaps to 5% intervals (50, 55, 60, ..., 95, 100), auto-switches at >100%
- Electric: Fixed at 100% (not draggable in current implementation)
- Modal shows current efficiency percentage + COP/HSPF when >100%
- Higher HEAT% = better heating system efficiency

##### MVHR% (Mechanical Ventilation Heat Recovery) - Section 13 ✅

**Storage Pattern:** d_118 stores as **percentage string** (same as DWHR%, not decimal like WWR)
- Example: 85% → "85.00" (not 0.85)

```javascript
'mvhr_efficiency': {
  targetField: 'd_118',     // HRV/ERV/MVHR Efficiency (SRE) - stores as percentage
  refField: 'ref_d_118',
  min: 0,
  max: 100,
...
**pcConfig.js:** NO multiplier needed (d_118 already stores as percentage)
```javascript
{
  id: "mvhr_efficiency",
  targetField: "d_118",            // d_118 stores as percentage (89 means 89%)
  referenceField: "ref_d_118",     // ref_d_118 stores as percentage
  // NO targetFieldMultiplier - already in percentage format
  domain: [0, 100],
}
```

**Key Implementation Notes:**
- Section 13 calls this "SRE" (Sensible Recovery Efficiency) internally, but user-facing label is MVHR%
- **CRITICAL:** Unlike WWR (stores as decimal 0.33), MVHR% stores as percentage (85)
- Pattern matches DWHR% (percentage storage), not WWR (decimal storage)
- 0.5% step allows easy dragging while preserving precision for Excel imports
